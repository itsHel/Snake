/*! For license information please see main.8715b9b7.js.LICENSE.txt */
!(function () {
    "use strict";
    var e = {
            110: function (e, n, t) {
            ...
            463: function (e, n, t) {
                ...
                var lu = {
                    ...
                    cu = {
                        ...
                        useTransition: function () {
                            return [zl(Ol)[0], Pl().memoizedState];
                        },
                        useMutableSource: Tl,
                        useSyncExternalStore: Ml,
                        useId: eu,
                ...
                function yc(e, n) {
                    ...
                    if ((So(), (Ni = t), (_i.current = r), null !== Ti))
                        throw Error(o(261));
    ...
    (t.g = (function () {
        ...
        (function () {
            ...
            var En = (function (e) {
                ...
                name: "board",
                initialState: {
                    value: new Array(wn).fill([]).map(function () {
                        return new Array(wn).fill(bn.EMPTY);
                    }),
                    snakeHead: { y: 0, x: 0 },
                    snakeEnd: { y: 0, x: 0 },
                    snakeDirection: Sn,
                    snakeLatestDirection: Sn,
                    snakeEndDirectionStack: new Array(kn - 1).fill(Sn),
                    doubleMove: !1,
                    snakeSpeed: 370,
                    eatenCount: 0,
                    unpaused: !1,
                ...
                reducers: {
                    clearSnake: function (e) {
                        ...
                        (e.value[e.snakeEnd.y][e.snakeEnd.x] = bn.DEAD),
                    ...
                    moveSnake: function (e) {
                        ...
                        for (var t = 0; t < n; t++) {
                            ...
                            if (
                                (e.value[r.y][r.x] === bn.SNAKE ||
                                    e.value[r.y][r.x] === bn.ROCK ||
                                    e.value[r.y][r.x] === bn.HEAD) &&
                            ...
                            if (
                                ...
                                e.value[r.y][r.x] === bn.FOOD)
                            ) {
                                var a = Pn(e.value);
                                (e.value[a.y][a.x] = bn.FOOD),
                                    (e.eatenCount += 1),
                    ...
                    resetBoard: function (e, n) {
                        ...
                        for (var t = 0; t < e.value.length; t++)
                            for (var r = 0; r < e.value[t].length; r++)
                                e.value[t][r] = bn.EMPTY;
                        function a(n, t, r, o, l) {
                            if (!(t <= 0)) {
                                for (var u = n, i = 0; i < t; i++)
                                    (e.value[u.y][u.x] = bn.ROCK),
                                        (u = _n(u, r));
                                switch (r) {
                                    case "west":
                                        r = "north";
                        ...
                        !(function (t) {
                                                ...
                                                (s === Math.floor(wn / 2) ||
                                                    ...
                                                    (s ===
                                                        Math.floor(wn / 2) +
                                                            1 &&
                                                        l))) ||
                                                (e.value[s][i[c]] = bn.ROCK);
                                    break;
                                case 2:
                                    for (var f = (r = 3); f < wn - r; f++)
                                        f === Math.floor(wn / 2) ||
                                            f === Math.floor(wn / 2) - 1 ||
                                            (f === Math.floor(wn / 2) + 1 &&
                                                l) ||
                                            ((e.value[f][f] = bn.ROCK),
                                            (e.value[f][wn - f - 1] = bn.ROCK));
                                    break;
                                case 3:
                                    for (var d = 0; d < wn; d++)
                                        (e.value[0][d] = bn.ROCK),
                                            (e.value[wn - 1][d] = bn.ROCK),
                                            (e.value[d][0] = bn.ROCK),
                                            (e.value[d][wn - 1] = bn.ROCK);
                                    break;
                                case 4:
                                    for (var p = 2 * wn, h = 0; h < p; h++) {
                                        var v = void 0,
                                            m = void 0;
                                        do {
                                            (v = Math.floor(
                                ...
                                case 6:
                                    for (
                                        ...
                                        for (
                                            ...
                                            e.value[k][y[g]] = bn.ROCK;
                                        for (var S = 0; S < w; S++)
                                            e.value[wn - S - 1][y[g]] = bn.ROCK;
                                    }
                                    for (
                                        var x = Cn(
                                                Math.round(0.25 * wn),
                            ...
                            (function () {
                                ...
                                for (var l = n - kn + 1; l <= n; l++)
                                    e.value[t][l] = bn.SNAKE;
                                (e.snakeHead = { y: t, x: n }),
                                    (e.value[t][n] = bn.HEAD),
                                    (e.snakeEnd = { y: t, x: n - kn + 1 });
                                var u = Pn(e.value);
                                e.value[u.y][u.x] = bn.FOOD;
                            })();
                    },
                },
            });
            ...
            function Pn(e) {
                var n, t;
                do {
                    (n = Math.floor(Math.random() * wn)),
                        (t = Math.floor(Math.random() * wn));
                } while (0 !== e[n][t]);
                return { y: n, x: t };
            }
            var On = En.actions,
            ...
            function Hn(e) {
                ...
                return (0, Wn.jsx)("div", { className: "square " + n });
            }
            var Kn = (0, e.memo)(function (e) {
                    return (0, Wn.jsx)("div", {
                        className: "board-row",
                        children: e.data.map(function (e, n) {
                            return (0, Wn.jsx)(Hn, { type: e }, n);
                        }),
                    });
                }),
                Qn = 80;
            ...
            function Yn(e) {
                for (
                    ...
                    t(r);
                return (0, Wn.jsx)("div", { id: "pick-level", children: n });
            }
            function Xn() {
            ...
            function Jn() {
                var n = Un(),
                    t = Bn((0, e.useState)("show-board"), 2),
                    r = t[0],
                    a = t[1];
                return (0, Wn.jsxs)("div", {
                    id: "body",
            ...
            var et = function () {
                    ...
                    return (0, Wn.jsxs)("div", {
                        ...
                        tabIndex: 0,
                        children: [(0, Wn.jsx)(Zn, {}), (0, Wn.jsx)(Jn, {})],
                    });
                },
                nt = document.getElementById("root");
            (0, n.s)(nt).render(
                (0, Wn.jsx)(e.StrictMode, {
                    children: (0, Wn.jsx)(g, {
                        store: An,
                        children: (0, Wn.jsx)(et, {}),
                    }),
                }),
            );
        })();
})();
//# sourceMappingURL=main.8715b9b7.js.map
